const Work = () => {
    return (
        <div class="animate__animated animate__fadeInUp min-h-screen py-6 flex flex-col justify-center sm:py-12">
  <div class="py-3 sm:max-w-xl sm:mx-auto w-full px-2 sm:px-0">
    ...
    <div class="relative text-gray-700 antialiased text-sm font-semibold">
        ...
        <div class="flex flex-col sm:flex-row items-center">
          <div class="flex justify-start w-full mx-auto items-center">
            <div class="w-full sm:w-1/2 sm:pr-8">
              <div class="p-4 animate__animated animate__backInLeft bg-white rounded shadow">
        ...
        <div class="flex flex-col sm:flex-row items-center">
          <div class="flex justify-end w-full mx-auto items-center">
            <div class="w-full sm:w-1/2 sm:pl-8">
              <div class="p-4 animate__animated animate__backInRight bg-white rounded shadow">
      ...
      <div class="mt-6 sm:mt-0 sm:mb-12">
        ...
        //     <div class="">
        //          <div class="animate__animated animate__fadeInUp items-cente w-auto py-6 flex flex-col justify-center sm:py-12">
        //          <div class="py-3 sm:max-w-xl sm:mx-auto w-full px-2 sm:px-0">
